...
<div id="acm-clients-<?php echo $module->id; ?>" class="acm-clients style-1 <?php if($gray): ?> img-grayscale <?php endif; ?> <?php echo $style; ?> <?php if($count > $columns): ?> multi-row <?php endif; ?>">
