...
if ($this->allowRating || $this->allowReview || $this->showRating || $this->showReview) {
	...
	$ratingWidth = $maxrating*12;
	for( $num = 0; $num<=$maxrating; $num++ ) {
		$stars[] = '
				<span title="'.(vmText::_( "COM_VIRTUEMART_RATING_TITLE" ).$num.'/'.$maxrating).'" class="vmicon ratingbox" style="display:inline-block;width:'. 12*$maxrating.'px;">
					<span class="stars-orange" style="width:'.(12*$num).'px">
					</span>
				</span>';
	}
