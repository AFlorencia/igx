...
<div class="productdetails-view productdetails">
    ...
    <div class="vm-product-container">
        ...
        <?php $customFields = $this->product->customfieldsSorted;$newCustomField=array();
        if (!empty($customFields['ontop'])):
          foreach ($customFields['ontop'] AS $custom): ?>
            <?php $newCustomField[preg_replace('/[^a-zA-Z0-9_]+/', '_', $custom->custom_title)]['value'][] = '<span class="badge badge-'.strtolower($custom->display).'">'.strtolower($custom->display).'</span>'; ?>
          ...
          <?php foreach ($newCustomField AS $ncf) :?>
            <?php echo $cusopenTag; ?><?php echo implode($ncf['value'], $cusclosetag.$customSeperator.$cusopenTag); ?><?php echo $cusclosetag; ?>
          <?php endforeach; ?>
        <?php endif; ?>
      <?php endif; ?>
